...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="assetspdf/img/favicons/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="assetspdf/img/favicons/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="assetspdf/img/favicons/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="assetspdf/img/favicons/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="assetspdf/img/favicons/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="assetspdf/img/favicons/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="assetspdf/img/favicons/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="assetspdf/img/favicons/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="assetspdf/img/favicons/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192" href="assetspdf/img/favicons/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="assetspdf/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="assetspdf/img/favicons/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="assetspdf/img/favicons/favicon-16x16.png">
    <link rel="manifest" href="assetspdf/img/favicons/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="assetspdf/img/favicons/ms-icon-144x144.png">
	...
	============================== -->
    <!-- Bootstrap -->
    <link rel="stylesheet" href="assetspdf/css/bootstrap.min.css">
    <!-- Theme Custom CSS -->
    <link rel="stylesheet" href="assetspdf/css/style.css">
...
============================== -->
    <!-- Jquery -->
    <script src="assetspdf/js/vendor/jquery-3.6.0.min.js"></script>
    <!-- Bootstrap -->
    <script src="assetspdf/js/bootstrap.min.js"></script>
    <!-- PDF Generator -->
    <script src="assetspdf/js/jspdf.min.js"></script>
    <script src="assetspdf/js/html2canvas.min.js"></script>
    <!-- Main Js File -->
    <script src="assetspdf/js/main.js"></script>
